...
class AuthenticationIntegrationTest {
    ...
    private RegisterRequest createRegisterRequest() {
        return createRegisterRequest("vinay@test.com", "Password@123", "Vinay", "R");
    }

    private RegisterRequest createRegisterRequest(String email, String password, String firstName, String lastName) {
    ...
    void shouldNotRegisterDuplicateEmail() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.message").value("User with email " + registerRequest.getEmail() + " already exists"));
    ...
    void shouldReturnUnauthorizedWithInvalidJwt() throws Exception {
        ...
        mockMvc.perform(get("/api/users/me").header("Authorization", "Bearer invalid.jwt.token"))
                .andExpect(status().isUnauthorized())
                .andExpect(jsonPath("$.success").value(false))
                .andExpect(jsonPath("$.message").value("Invalid email or password"));
    }
